...
function WorkoutItem ({isModalOpen, toggleModal, workoutItemData, toggleItemFullData, shouldWarn, deleteItem, formatRestTimer, setShouldStartWarning} = this.props) {

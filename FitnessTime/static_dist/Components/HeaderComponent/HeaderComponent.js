...
function Header ({
  ...
  return (
    <div className="header">
      ...
      <Menu menuClass={classNames("header__action", "menu_header", {hidden: !routeParams.id || !isPageExist})} triggerClass="menu__trigger_header" wrapperClass="menu__wrapper_header">
